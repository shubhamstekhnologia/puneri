...
class HomeComponentApiController extends Controller
{
    ...
    public function get_home_component_details(Request $request)
    {
        ...
        if ($erase_data_status == 'Yes') {
            ...
            $get_home_component_details = HomeComponent::where('admin_auto_id', $request->admin_auto_id)->orwhere('admin_auto_id', "6306fc8918573a0e5ba5a218")->where('_id', '=', $request->get('component_auto_id'))->where('component_type', '=', $request->get('component_type'))->where('app_type_id', $request->app_type_id)->get();
        }
        $i = 0;
        foreach ($get_home_component_details as $list) {
            ...
            if ($list->component_type == "Slider") {
                ...
                if ($erase_data_status == 'Yes') {
                    $component_content = ComponentContent::where('component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $component_content = ComponentContent::where('component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
            ...
            if ($list->component_type == "Offers") {
                ...
                if ($erase_data_status == 'Yes') {
                    $component_content = OfferComponent::where('homecomponent_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $component_content = OfferComponent::where('homecomponent_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                $get_home_component_details[$i]['content'] = $component_content;
            }
            ...
            if ($list->component_type == "Recommneded Product") {
                ...
                if ($erase_data_status == 'Yes') {
                    $component_content = HomeComponent::where('_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $component_content = HomeComponent::where('_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                $get_home_component_details[$i]['content'] = $component_content;
            }
            ...
            if ($list->component_type == "Products") {
                ...
                if ($erase_data_status == 'Yes') {
                  $check_component_content = HomeProductComponent::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                  $check_component_content = HomeProductComponent::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                if ($check_component_content->isEmpty()) {
                   $get_home_component_details[$i]['content'] = $check_component_content;
                    ...
                    if ($erase_data_status == 'Yes') {
                      $component_content = HomeProductComponent::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                    } else {
                       $component_content = HomeProductComponent::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                    }
                    foreach ($component_content as $cc) {
                        ...
                        foreach ($product_auto_ids as $product) {
                            ...
                            if ($erase_data_status == 'Yes') {
                                ...
                                $country_user = UserRegister::where('_id', '=', $request->get('customer_auto_id'))->where('admin_auto_id', $request->admin_auto_id)->get();
                                if ($country_user->isNotEmpty()) {
                                    foreach ($country_user as $cuid) {
                                      $country_code = $cuid->country_code;
                                    }
                                } else {
                                    $country_users = EcommRegistration::where('_id', '=', $request->get('customer_auto_id'))->get();
                                ...
                                $country_user = UserRegister::where('_id', '=', $request->get('customer_auto_id'))->get();
                                if ($country_user->isNotEmpty()) {
                                    foreach ($country_user as $cuid) {
                                        $country_code = $cuid->country_code;
                                    }
                            ...
                            if ($erase_data_status == 'Yes') {
                                $currency_user = Currency::where('country_code', '=', $country_code)->where('admin_auto_id', $request->admin_auto_id)->get();
                            } else {
                              $currency_user = Currency::where('country_code', '=', $country_code)->where('admin_auto_id', '=', "6306fc8918573a0e5ba5a218")->get();
                            }
                            ...
                            if ($erase_data_status == 'Yes') {
                                $currency_price_detailss = CountryProductPrice::where('admin_auto_id', $request->admin_auto_id)->where('currency_auto_id', '=', $country_code_id)->where('app_type_id', $request->app_type_id)->get();
                            } else {
                                $currency_price_detailss = CountryProductPrice::Where('admin_auto_id', "6306fc8918573a0e5ba5a218")->where('currency_auto_id', '=', $country_code_id)->where('app_type_id', $request->app_type_id)->get();
                            }
                            if ($currency_price_detailss->isNotEmpty()) {
                                ...
                                if ($erase_data_status == 'Yes') {
                                    $pcat = AdminProducts::where('_id', '=', $product)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                } else {
                                   $pcat = AdminProducts::where('_id', '=', $product)->Where('admin_auto_id', "6306fc8918573a0e5ba5a218")->where('app_type_id', $request->app_type_id)->get();
                                }
                                if (empty($pcat)) {
                                    ...
                                    foreach ($pcat as $urs) {
                                       $product_auto_id = $urs->_id;
                                        ...
                                        if ($size != "") {
                                            foreach ($size_ids as $sz) {
                                                ...
                                                if ($erase_data_status == 'Yes') {
                                                    ...
                                                    $sizelist = SizeLists::where('_id', '=', $sz)->where('admin_auto_id', $request->admin_auto_id)->get();
                                                } else {
                                        ...
                                        if ($erase_data_status == 'Yes') {
                                            ...
                                            $currency_price_details = CountryProductPrice::where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->where('currency_auto_id', '=', $country_code_id)->where('product_auto_id', '=', $product_auto_id)->get();
                                        } else {
                                          $currency_price_details = CountryProductPrice::Where('admin_auto_id', "6306fc8918573a0e5ba5a218")->where('app_type_id', $request->app_type_id)->where('currency_auto_id', '=', $country_code_id)->where('product_auto_id', '=', $product_auto_id)->get();
                                        }
                                        ...
                                        if ($erase_data_status == 'Yes') {
                                            ...
                                            $get_details = AdminProducts::where('product_model_auto_id', '=', $product_model_auto_id)->where('admin_auto_id', $request->admin_auto_id)->where('product_name', '=', $product_name)->where('app_type_id', $request->app_type_id)->get();
                                        } else {
                                            $get_details = AdminProducts::where('product_model_auto_id', '=', $product_model_auto_id)->where('product_name', '=', $product_name)->where('app_type_id', $request->app_type_id)->get();
                                        }
                                        ...
                                        foreach ($offer_ids as $offer) {
                                            ...
                                            if ($erase_data_status == 'Yes') {
                                                ...
                                                $offerlist = OfferComponent::where('_id', '=', $offer)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                            } else {
                                                $offerlist = OfferComponent::where('_id', '=', $offer)->where('app_type_id', $request->app_type_id)->get();
                                            }
                                        ...
                                        if ($erase_data_status == 'Yes') {
                                            ...
                                            $pimage_details = AdminProductImages::where('admin_auto_id', $request->admin_auto_id)->where('product_auto_id', '=', $product_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                        } else {
                                           $pimage_details = AdminProductImages::where('product_auto_id', '=', $product_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                        }
                                        ...
                                        if ($erase_data_status == 'Yes') {
                                            ...
                                            $courseRatingReview = ProductRatingReview::Where('product_auto_id', $product_auto_id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                            $courseRatingReviewCount = ProductRatingReview::Where('product_auto_id', $product_auto_id)->where('app_type_id', $request->app_type_id)->count();
                                        } else {
                                          $courseRatingReview = ProductRatingReview::Where('product_auto_id', $product_auto_id)->where('app_type_id', $request->app_type_id)->get();
                                            $courseRatingReviewCount = ProductRatingReview::Where('product_auto_id', $product_auto_id)->where('app_type_id', $request->app_type_id)->count();
                                        }
                                        $avg_rating = 0;
                                        if ($courseRatingReview->isNotEmpty()) {
                                            foreach ($courseRatingReview as  $data) {
                                                ...
                                                if ($erase_data_status == 'Yes') {
                                                    ...
                                                    $total_student = UserRegister::Where('_id', $data->customer_auto_id)->where('admin_auto_id', $request->admin_auto_id)->count();
                                                } else {
            ...
            if ($list->component_type == "MainCategories") {
                ...
                if ($erase_data_status == 'Yes') {
                    $check_component_content = HomeComponentMainCategories::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $check_component_content = HomeComponentMainCategories::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                if ($check_component_content->isEmpty()) {
                    $get_home_component_details[$i]['content'] = $check_component_content;
                } else {
                    ...
                    if ($erase_data_status == 'Yes') {
                        $component_content = HomeComponentMainCategories::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                    } else {
                        $component_content = HomeComponentMainCategories::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                    }
                    foreach ($component_content as $cc) {
                        ...
                        foreach ($maincat_ids as $main) {
                            ...
                            if ($erase_data_status == 'Yes') {
                                $mlists = Categories::where('_id', $main)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                            } else {
                                $mlists = Categories::where('_id', $main)->where('app_type_id', $request->app_type_id)->get();
                            }
            ...
            if ($list->component_type == "SubCategories") {
                ...
                if ($erase_data_status == 'Yes') {
                    $check_component_content = HomeComponentSubCategories::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $check_component_content = HomeComponentSubCategories::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                if ($check_component_content->isEmpty()) {
                    $get_home_component_details[$i]['content'] = $check_component_content;
                } else {
                    ...
                    if ($erase_data_status == 'Yes') {
                        $component_content = HomeComponentSubCategories::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                    } else {
                        $component_content = HomeComponentSubCategories::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                    }
                    foreach ($component_content as $cc) {
                        ...
                        foreach ($subcat_ids as $sub) {
                            ...
                            if ($erase_data_status == 'Yes') {
                                $lists = Subcategories::where('_id', $sub)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                            } else {
                                $lists = Subcategories::where('_id', $sub)->where('app_type_id', $request->app_type_id)->get();
                            }
                            if ($lists->isNotEmpty()) {
            ...
            if ($list->component_type == "Brand") {
                ...
                if ($erase_data_status == 'Yes') {
                    $check_component_content = HomeComponentTopBrands::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                } else {
                    $check_component_content = HomeComponentTopBrands::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                }
                if ($check_component_content->isEmpty()) {
                    $get_home_component_details[$i]['content'] = $check_component_content;
                } else {
                    ...
                    if ($erase_data_status == 'Yes') {
                        $component_content = HomeComponentTopBrands::where('home_component_auto_id', $id)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                    } else {
                        $component_content = HomeComponentTopBrands::where('home_component_auto_id', $id)->where('app_type_id', $request->app_type_id)->get();
                    }
                    foreach ($check_component_content as $cc) {
                        ...
                        foreach ($brand_ids as $b) {
                            ...
                            if ($erase_data_status == 'Yes') {
                                $lists = Brand::where('_id', $b)->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
                            } else {
                                $lists = Brand::where('_id', $b)->where('app_type_id', $request->app_type_id)->get();
                            }
                            if ($lists->isNotEmpty()) {
    ...
    public function get_main_category_components(Request $request)
    {
        ...
        if ($erase_data_status == 'Yes') {
            $get = HomeComponent::where('show_in_category', 'LIKE', '%' . $main_category_auto_id . '%')->where('admin_auto_id', $request->admin_auto_id)->where('app_type_id', $request->app_type_id)->get();
        } else {
            $get = HomeComponent::where('show_in_category', 'LIKE', '%' . $main_category_auto_id . '%')->where('app_type_id', $request->app_type_id)->where('admin_auto_id', $request->admin_auto_id)->orWhere('admin_auto_id', "6306fc8918573a0e5ba5a218")->get();
        }
