    ...
    <div class="container">
        ...
        <div class="row">
              @if(!empty($product_lists))
                  ...
                  @php $i++; @endphp
            <div class="filter_data product_container col-lg-3 col-md-6 col-sm-10 offset-md-0 offset-sm-1" style="height:400px;">
                <div class="card" style="padding:5px;"> <a href="{{url('product-detail',$products['_id'])}}">
                                    ...
                                    <div class="carousel-wrap">
                                      ...
                                      @foreach($pimages_lists as $wholesalers)
                                        ...
                                        @if($products->_id == $wholesalers->product_auto_id)
                                            ...
                                            <div class="item"><img src="../images/products_images/{{$wholesalers["image_file"]}}" style="height:250px;"></div>
                    ...
                    <div class="card-body" style="padding:5px;">
                        ...
                        <div class="rounded bg-white discount" id="orange" style="background:rgba(255,63,108,.8);">{{$rating}} <i class="fa fa-star" aria-hidden="true" style="color: turquoise;"></i> | {{$total_rating_count}}</div>
                          ...
                          @if (Session::has('AccessTokens') !='')
                            ...
                            {!! Form::open(['method' => 'POST', 'url' => 'wishlist', 'enctype' => 'multipart/form-data']) !!}
                             ...
                             <input name="product_auto_id" type="hidden" value="{{$products["_id"]}}" />
                               @if(!empty($wproducts))
                                <button type="submit" class="btn btn-info" style="margin-top: -50px;float: right;padding: 3px;color:red;"><i class="fa fa-light fa-heart" ></i></button>
                                   @else
                            <button type="submit" class="btn btn-info" style="margin-top: -50px;float: right;padding: 3px;"><i class="fa fa-light fa-heart" ></i></button>
                                  @endif
                            </form>
                        @else
                            <button type="submit" class="btn btn-info" style="margin-top: -50px;float: right;padding: 3px;"><i class="fa fa-light fa-heart" ></i></button>
                        ...
                        <h6 class="price" style="font-size: 12px;">
                            ...
                            <del style="text-decoration: line-through;">Rs. {{$cprice["product_price"]}}</del>
                        ...
                        @else
                            <button onclick="location.href = '../login';" type="submit" class="btn btn-sm btn-danger" style="color:white;font-size:13px;background:purple;border:purple;">Buy Now</button>
                            

                        @endif
                      
                          @if (Session::has('AccessTokens') !='')
                        <p class="btn-holder"><a href="{{ route('add.to.cart', $products->id) }}" class="btn btn-sm btn-warning text-center" role="button" style="font-size: 13px;background: #fd7f34;border: #fd7f34;float: right;margin-top: -23px;">Add to cart</a> </p>
                         @else
                     
                    <button onclick="location.href = '../login';" type="submit" class="btn btn-sm btn-warning text-center" style="font-size: 13px;background: #fd7f34;border: #fd7f34;float: right;">Add to cart</button>
