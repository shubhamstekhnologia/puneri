                    ...
                    <div class="d-flex flex-column ">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-group">
                                ...
                                <input id="mobile_number" type="tel" class="form-control" name="mobile_number" value="{{$mobile_number}}" required
                                   readonly autofocus />
                            ...
                            <div class="mt-3">
                                <p class="mb-0 text-muted">Do not have an account? <a href="{{url('registration')}}"
                                        style="color:blue" id="show_register()">Register now</a></p>
