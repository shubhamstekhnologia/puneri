        ...
        <div class="body d-md-flex align-items-center justify-content-between position-relative">
            ...
            <div class="box-2 d-flex flex-column h-auto">
                ...
                <div class="mt-5 login_info text-black">
                    ...
                    <p class="mb-1 h-1">Enter Otp</p>
                    <p class="text-muted mb-2">If not recieved otp check mobile number again..!</p>
                    <div class="d-flex flex-column ">

                        <div class="d-flex align-items-center">
                            {!! Form::open(['method' => 'POST', 'url' => 'verify_registration_otp', 'enctype' =>
                            'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input id="mobile_number" type="text" class="form-control" name="mobile_number" required
                                    pattern="[0-9]{10}" title="Please enter a 10-digit valid number"
                            ...
                            <div class="form-group">
                                ...
                                <input id="otp" type="text" class="form-control" name="otp" required
                                    pattern="[0-9]{4}" title="Please enter a 4-digit valid otp" />
                            </div>
                            ...
                            <div class="mt-3">
                                <p class="mb-0 text-muted"> Already have an account? <a
