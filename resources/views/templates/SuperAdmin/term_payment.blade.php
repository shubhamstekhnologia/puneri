            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <strong class="card-title">Terms & Conditions For Proceed to Pay</strong>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header"><strong>Update Terms & Conditions For Proceed to Pay</strong></div>

                                <div class="card-body card-block"> 

                                    @include('templates.SuperAdmin.messages')

                                    {!! Form::open(['method' => 'POST', 'url' => 'updateTermConditionPayment', 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        <div class="form-group col-md-12">
                                           ...
                                           <label for="vat" class="form-control-label">Terms & Conditions For Proceed to Pay</label>
                                       ...
                                       <textarea cols="80" id="term" name="term" rows="10" class="form-control" >{{$term}}</textarea>
                                        ...
                                        <div class="card-footer col-md-12">  
                                            ...
                                            <button type="button" class="btn btn-info btn-sm"><i class="fa fa-times-circle-o" aria-hidden="true"></i> <a href="{{url('termConditionPayment')}}">Cancel</a></button> 
