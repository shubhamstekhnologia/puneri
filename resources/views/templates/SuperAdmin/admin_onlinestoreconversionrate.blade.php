...
<br/>
<center><h3>Online Store Conversion Rate</h3></center>
    <div class="container-fluid">
       ...
       <div class="row">
           <div class="col-md-12">
               <div class="row">
                   <div class="col-md-4" style="padding: 20px;"><center><b>Added to Cart</b><br/>
                   0 sessions<br/>0.00%
                   </center></div>
               <div class="col-md-4" style="padding: 20px;"><center><b>Reached Checkout</b><br/>
                   0 sessions<br/>0.00%</center></div>
               <div class="col-md-4" style="padding: 20px;"><center><b>Sessions Converted</b><br/>
                   0 sessions<br/>0.00%</center></div>
               </div>
 ...
 <button type="submit" class="btn btn-sm btn-danger btn_add_columns">Add Columns</button>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      <div class="table-responsive">
        ...
        <th style="font-weight:500;">Sessions</th>
         <th style="font-weight:500;">Added to Cart</th>
        <th style="font-weight:500;">Reached Checkout</th>
       <th style="font-weight:500;">Sessions Converted</th>
        <th style="font-weight:500;">Conversion Rate</th>
    ...
    <div class="col-md-12">
        ...
        <center><h3>Conversion Rate</h3></center><br/>
