                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header"><strong>Update About Us</strong></div>

                                <div class="card-body card-block"> 

                                    @include('templates.SuperAdmin.messages')

                                    {!! Form::open(['method' => 'POST', 'url' => 'update-about', 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        <div class="form-group col-md-12">
                                          ...
                                          <label for="vat" class="form-control-label">About Us</label>
                                          <textarea cols="80" id="about" name="about" rows="10" class="form-control" >{{$about}}</textarea>
                                        ...
                                        <div class="card-footer col-md-12">  
                                            ...
                                            <button type="button" class="btn btn-info btn-sm"><i class="fa fa-times-circle-o" aria-hidden="true"></i> <a href="{{url('about')}}">Cancel</a></button> 
